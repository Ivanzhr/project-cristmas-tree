...
@Component({
  ...
  templateUrl: './product-garland-details.component.html',
  styleUrl: './product-garland-details.component.scss'
})
export class ProductGarlandsDetailsComponent implements OnInit {
  private productId: number | null = null;
  product: IPgarlands | null = null;
